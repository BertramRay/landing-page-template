      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 lg:gap-12">
          <div className="col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              <Bot className="h-8 w-8 text-primary" strokeWidth={1.5} />
              <span className="font-bold text-xl">SEOBot</span>
            </div>
            <p className="text-muted-foreground mb-6 max-w-md">
              Automate your SEO content creation with AI precision. Generate high-quality, optimized blog posts that rank well and drive traffic.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#" className="text-base text-muted-foreground hover:text-gray-900">About</a></li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-base text-muted-foreground hover:text-gray-900">Security</a></li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-200 flex flex-col md:flex-row justify-between items-center">
          <p className="text-base text-muted-foreground">
            &copy; {new Date().getFullYear()} SEOBot. All rights reserved.
          </p>
